 ...
 * 
 */
package com.cloudpaas.cache.service;
 ...
 */
public interface IRedisSService {
	/**
     * <p>
     ...
     * @return 成功返回value 失败返回null
     */
    Set<String> getByPrefix(String prefix);
     ...
     * @param key
     * @param str
     * @return 成功返回 添加后value的长度 失败 返回 添加的 value 的长度 异常返回0
     */
     ...
     * @return
     */
    Long sinterstore(String key, String otherkey,String dstKey);
