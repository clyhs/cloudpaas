layui.define(["element", "jquery","tool","api"], function (exports) {
    ...
    adminui = new function () {
        ...
        this.initHome = function (data) {
            window.sessionStorage.setItem('layuiminiHomeHref', data.href);
        ...
        this.initMenu = function (data) {
            ...
            leftMenuHtml += '<ul class="layui-nav layui-nav-tree layui-left-nav-tree ' + leftMenuCheckDefault + '" id="current">\n';
            var menuList = data;
            ...
            if (urlArr.length >= 2) {
                ...
                if (!checkTab) {
                    ...
                    var layuiminiHomeTab = $('#layuiminiHomeTab').attr('lay-id'),
                        layuiminiHomeHref = window.sessionStorage.getItem('layuiminiHomeHref');
        ...
        this.addTab = function (tabId, href, title, addSession) {
            if (addSession == undefined || addSession == true) {
                ...
                window.sessionStorage.setItem("layuiminiTabInfo", JSON.stringify(layuiminiTabInfo));
            }
