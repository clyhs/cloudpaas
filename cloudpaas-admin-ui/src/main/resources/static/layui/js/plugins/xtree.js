...
//封装IE8 Class选择
xtree.prototype.getByClassName = function (cn) {
...
//在一个对象下面找子级
xtree.prototype.getChildByClassName = function (obj, cn) {
...
//加载特效，且获取数据
xtree.prototype.Loading = function (options) {
    var _this = this;
...
//data验证后的数据初始化
xtree.prototype.Initial = function (o) {
    var _this = this;
...
//全选框
xtree.prototype.CreateCkAll = function () {
    var _this = this;
    if (_this._ckall) {
...
//生产结构
xtree.prototype.dataBind = function (d) {
    var _this = this;
    if (d.length > 0) {
        for (i in d) {
            var xtree_isend = '';
...
//渲染呈现
xtree.prototype.Rendering = function () {
    var _this = this;
...
//子节点选中改变，父节点更改自身状态
xtree.prototype.ParendCheck = function (ckelem) {
    var _this = this;
...
xtree.prototype.ParentCheckboxChecked = function (e) {
    var _this = this;
...
//获取全部选中的末级checkbox对象
xtree.prototype.GetChecked = function () {
    var _this = this;
    var arr = new Array();
    var arrIndex = 0;
...
//获取全部的原始checkbox对象
xtree.prototype.GetAllCheckBox = function () {
    var _this = this;
    var arr = new Array();
    var arrIndex = 0;
    var cks = _this.getByClassName('layui-xtree-checkbox');
...
xtree.prototype.GetParent = function (a) {
    var _this = this;
    var cks = _this.getByClassName('layui-xtree-checkbox');
    for (var i = 0; i < cks.length; i++) {
        if (cks[i].value == a) {
